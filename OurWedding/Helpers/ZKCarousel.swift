...
final public class ZKCarousel: UIView, UICollectionViewDelegateFlowLayout, UICollectionViewDelegate, UICollectionViewDataSource {
	...
	lazy var collectionView : UICollectionView = {
        ...
        let cv = UICollectionView(frame: CGRect(x: 0, y: 0, width: UIScreen.main.bounds.size.width, height: 250.0), collectionViewLayout: layout)
        cv.delegate = self
        cv.dataSource = self
...
fileprivate class carouselCollectionViewCell: UICollectionViewCell {
    ...
    private lazy var imageView : UIImageView = {
		let iv = UIImageView(frame:CGRect(x: 0, y: 0, width: UIScreen.main.bounds.size.width, height: 250.0))
    ...
    override init(frame: CGRect) {
        super.init(frame: CGRect(x: 0, y: 0, width: UIScreen.main.bounds.size.width, height: 250.0))
        setup()
    }
